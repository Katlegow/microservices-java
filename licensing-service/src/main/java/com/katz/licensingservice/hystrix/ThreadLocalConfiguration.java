...
public class ThreadLocalConfiguration {
    ...
    @Autowired
    public ThreadLocalConfiguration(HystrixConcurrencyStrategy existing) {
    ...
    public void init() {
        ...
        HystrixPlugins.getInstance().registerConcurrencyStrategy(new ThreadLocalAware(existing));
